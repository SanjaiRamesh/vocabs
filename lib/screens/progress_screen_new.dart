...
class _ProgressScreenState extends State<ProgressScreen>
        ...
        child: Column(
          ...
          children: [
            ...
            ...wordAttempts.entries.map(
              (entry) => _buildWordRow(entry.key, entry.value),
            ),
          ],
        ),
      ),
  ...
  Widget _buildWordRow(String word, List<WordAttempt> wordAttempts) {
        ...
        children: [
          ...
          ...repetitionDays.asMap().entries.map((entry) {
            ...
            if (stepAttempts.isEmpty) {
              return _buildEmptyCell(stepDay);
            }
            ...
            return _buildResultCell(lastAttempt, stepDay, stepAttempts);
          }),
        ],
      ),
    );
  ...
  Widget _buildEmptyCell(int stepDay) {
    return Container(
      width: 80,
      height: 60,
      decoration: BoxDecoration(
      ...
      child: Container(
        padding: const EdgeInsets.all(4), // Reduced padding from 8 to 4
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          mainAxisSize: MainAxisSize.min, // Prevent overflow
          children: [
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Show date if only one attempt total
                if (allStepAttempts.length == 1 && lastAttempt.date.isNotEmpty)
                  Padding(
                    padding: const EdgeInsets.only(top: 1),
                    child: Text(
                      _formatShortDate(lastAttempt.date),
