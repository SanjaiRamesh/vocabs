class WordSchedule {
  ...
  @override
  String toString() {
    return 'WordSchedule(word: $word, repetitionStep: $repetitionStep, lastReviewDate: $lastReviewDate, nextReviewDate: $nextReviewDate, incorrectCount: $incorrectCount, isHard: $isHard)';
  }
}
